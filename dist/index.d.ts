...
declare enum OwnershipEntityKind {
    Post = "Post",
    Space = "Space",
    Domain = "Domain"
}
interface EntityWithOwnership {
    kind: OwnershipEntityKind;
    id: string;
}
