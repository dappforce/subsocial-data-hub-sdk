...
declare const socialCallName: {
    ...
    readonly synth_social_profile_sync_external_token_balance: "synth_social_profile_sync_external_token_balance";
    ...
    readonly synth_create_external_token: "synth_create_external_token";
    readonly synth_access_set_role_permission: "synth_access_set_role_permission";
    readonly synth_access_set_user_role: "synth_access_set_user_role";
};
...
interface SynthSocialProfileSyncExternalTokenBalanceCallParsedArgs {
...
declare enum ExternalTokenChain {
    ETHEREUM = "ETHEREUM",
    SOLANA = "SOLANA"
}
type ExternalTokenMethodAliases = {
    balanceOf: string;
};
...
interface SynthCreateExternalTokenCallParsedArgs {
...
declare enum AccessPermissionContext {
    SPACE = "SPACE",
    POST = "POST"
}
...
declare enum DataHubSubscriptionEventEnum {
    ...
    SOCIAL_PROFILE_EXTERNAL_TOKEN_BALANCE_CREATED = "SOCIAL_PROFILE_EXTERNAL_TOKEN_BALANCE_CREATED",
    SOCIAL_PROFILE_EXTERNAL_TOKEN_BALANCE_STATE_UPDATED = "SOCIAL_PROFILE_EXTERNAL_TOKEN_BALANCE_STATE_UPDATED",
