...
declare const socialCallName: {
    ...
    readonly synth_social_profile_add_ref_id: "synth_social_profile_add_ref_id";
};
...
interface SynthSocialProfileAddRefIdCallParsedArgs {
    refId: string;
